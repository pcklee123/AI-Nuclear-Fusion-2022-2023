...
#pragma omp parallel for simd num_threads(nthreads)
        ...
        {
            if (pos1x[p][n] <= posL[0] + dd[0])
            {
                pos1x[p][n] = posL[0] + dd[0] * 1.5;
                pos0x[p][n] = pos1x[p][n];
            }
            if (pos1x[p][n] >= posH[0] - dd[0])
            {
                pos1x[p][n] = posH[0] - dd[0] * 1.5;
                pos0x[p][n] = pos1x[p][n];
            }
            if (pos1y[p][n] <= posL[1] + dd[1])
            {
                pos1y[p][n] = posL[1] + dd[1] * 1.5;
                pos0y[p][n] = pos1y[p][n];
            }
            if (pos1y[p][n] >= posH[1] - dd[1])
            {
                pos1y[p][n] = posH[1] - dd[1] * 1.5;
                pos0y[p][n] = pos1y[p][n];
            }
            ...
            if (pos1z[p][n] <= posL[2] + dd[2])
            {
                pos1z[p][n] = posL[2] + dd[2] * 1.5;
                pos0z[p][n] = pos1z[p][n];
            }
            if (pos1z[p][n] >= posH[2] - dd[2])
            {
                pos1z[p][n] = posH[2] - dd[2] * 1.5;
                pos0z[p][n] = pos1z[p][n];
            }
#endif
