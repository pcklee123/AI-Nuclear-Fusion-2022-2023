...
constexpr float r0_f = n_space / 16; //  radius of sphere or cylinder
...
constexpr float a0 = 1.0e-3;      // typical dimensions of a cell in m This needs to be smaller than debye length otherwise eenrgy is not conseved if a particle moves across a cell
